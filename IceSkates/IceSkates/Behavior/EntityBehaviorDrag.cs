...
namespace Bloodshed.Behaviors
{
    ...
    {
        public static IceSkatesModSystem Bloodshed => IceSkatesModSystem.Instance;
        ...
        private static float GlobalStakeDragModifier => Bloodshed.Config.GlobalStakeDragModifier; // Global modifier for all types of skates
        private static float WalkSpeedReductionWearingSkates => Bloodshed.Config.WalkSpeedReductionWearingSkates; // Walk speed reduction when below 50% stamina
        ...
        private static string AttributeKey => $"{IceSkatesModSystem.Instance.ModId}:stamina";
